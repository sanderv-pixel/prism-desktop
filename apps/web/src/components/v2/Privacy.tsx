    ...
    <section className="vault">
      <div className="wrap">
        ...
        <div style={{ marginTop: 10 }}>
          <div className="vline reveal">Your prompts are none of our business.</div>
          ...
          <div className="vline reveal">Never reads your prompts, code, or chats.</div>
          <div className="vline reveal">Never modifies your apps.</div>
          <div className="vline reveal">
